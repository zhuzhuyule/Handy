...
| 原计划                                                                                               | 实际实现                                                                                                                                                          | 原因                                                                            |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Task 1 仅引入 slot + helpers + 测试                                                                  | 新 helpers (`set_start_snapshot`, `take_start_snapshot`, `clear_start_snapshot_if_matches`) 临时加上 `#[allow(dead_code)]`，Task 2/3/4 接线后逐步移除；末态无残留 | CLAUDE.md 强制要求提交前消除所有 warning，未引用的新符号会触发 `dead_code` lint |
